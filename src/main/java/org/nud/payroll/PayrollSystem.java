...
public class PayrollSystem extends JFrame {
    ...
    static JTextField styledField(int cols) {
        ...
        tf.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(C_BORDER), BorderFactory.createEmptyBorder(8, 12, 8, 12)));
        return tf;
    }
    ...
    static JPanel surface(int padH, int padV) {
        ...
        p.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(C_BORDER), BorderFactory.createEmptyBorder(padV, padH, padV, padH)));
        return p;
    }
